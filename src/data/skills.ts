...
export const skillDomains: SkillDomain[] = [
  ...
  },
  {
    ...
    badge: "Applied AI",
    description: "Designing AI automations, deploying and tuning LLM-backed services, writing reliable prompts, and wiring AI APIs into real products.",
    skills: [
      {
        name: "AI Automation & Agentic Workflows",
        description: "Building tool-calling agents and AI pipelines that take real actions: shell tasks, browser runs, document parsing, and scheduled jobs.",
        proficiency: "Intermediate",
        experienceYears: "2+ yrs",
        tags: ["Hermes AI", "Function Calling", "Tool Schemas", "Browser Agents", "Webhooks"],
      },
      {
        name: "AI Deployment & Optimization",
        description: "Shipping LLM features to production and tuning them for speed and cost: model choice, caching, rate limits, and token budgets.",
        proficiency: "Intermediate",
        experienceYears: "2+ yrs",
        tags: ["Self-Hosted LLMs", "Latency Tuning", "Token Cost", "Response Caching", "Rate Limiting"],
      },
      {
        name: "Prompt Engineering & Structured Output",
        description: "System prompts, few-shot examples, and schema-bound outputs that stay on task, return valid JSON, and fail safely.",
        proficiency: "Mastery",
        experienceYears: "2+ yrs",
        tags: ["System Prompts", "Few-Shot", "JSON Schema", "Pydantic", "Guardrails"],
      },
      {
        name: "AI API Integration & Configuration",
        description: "Connecting LLM providers to apps and services: keys and secrets, model and parameter settings, streaming, and fallbacks.",
        proficiency: "Mastery",
        experienceYears: "2+ yrs",
        tags: ["LLM APIs", "Groq", "API Keys & Secrets", "Model Parameters", "Fallback Routing"],
      },
    ],
  },
  {
    id: "automation-software",
    domainNumber: "DOMAIN 07",
    title: "Automation, Scripting & Software",
    shortTitle: "Automation & Software",
    badge: "Engineering",
    description: "Bridging systems administration with modern software development, cloud deployment, and automated infrastructure scripting.",
    skills: [
      {
      ...
      },
      {
        ...
        description: "Shipping web apps, APIs and background workers with preview builds, environment secrets, and containerised services.",
        proficiency: "Intermediate",
        experienceYears: "2+ yrs",
        tags: ["Vercel", "Render", "Docker", "GitHub", "Env Secrets"],
      },
      {
